const menProduct = [

    {
        ...
        details: {
            ...
            description: "A casually dressed man sits on a sunlit concrete bench.",
            sku: "MJ-BRJ005",
...

    {
        ...
        category: "Checkered Shirt",
        price: "6000",
        details: {

            description: "A casually dressed man sits on a sunlit concrete bench.",
            sku: "MCS-CHECK-REDBLK-005",
            types: "Smart Casual",
            vendor: "C-EMERCE"
...

    {
        ...
        details: {
            ...
            description: "Blue striped shirt with navy tie and beige trousers outfit.",
            sku: "MBO-STRIPE-BLUE-001",
            types: "Formal Shirt",
            vendor: "C-EMERCE"
...

    {
        ...
        details: {
            ...
            description: "Tailored black suit, black shirt, sunglass, pocket square.",
            sku: "MFO-BLACK-SUIT-001",
