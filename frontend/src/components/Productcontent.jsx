...
function Productcontent({productHeading, productCategory, productPrice, cartButton}) {
    ...
    return (
        ...
        <div>
            ...
            <button className={ProductContentStyle.productCartButton}>{ cartButton }</button>
